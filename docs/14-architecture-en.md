...
| Limitation | Status |
|------------|--------|
| Skill-catalog section / channels section 404 placeholders | light up automatically once the upstream skill/channel endpoints merge (no plugin upgrade needed) |
