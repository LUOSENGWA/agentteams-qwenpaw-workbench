...
| Install media | The ZIP from the GitHub Releases page (`agentteams-qwenpaw-workbench-v0.5.0-beta.13.1.zip`) |
...
```
qwenpaw plugin install agentteams-qwenpaw-workbench-v0.5.0-beta.13.1.zip
```
