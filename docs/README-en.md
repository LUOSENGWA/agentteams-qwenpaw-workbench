...
- Version: v0.5.0-beta.13.23 (supports QwenPaw 2.0 – 2.2)

## Quick start (3 steps)

1. **Install**: `qwenpaw plugin install agentteams-qwenpaw-workbench-v0.5.0-beta.13.23.zip` (see [Install & upgrade](./01-install-en.md))
