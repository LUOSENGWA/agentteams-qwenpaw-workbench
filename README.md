...
**版本 Version**：0.5.0-beta.14 ｜ **作者 Author**：LUOSENGWA
...
qwenpaw plugin install /path/to/agentteams-qwenpaw-workbench-v0.5.0-beta.14.zip

# 从 URL 安装（支持 ZIP）/ install from URL (ZIP supported)
qwenpaw plugin install https://example.com/agentteams-qwenpaw-workbench-v0.5.0-beta.14.zip

# 强制重新安装（覆盖升级）/ force reinstall (upgrade in place)
qwenpaw plugin install /path/to/agentteams-qwenpaw-workbench-v0.5.0-beta.14.zip --force
```

**方式三：GitHub Release URL** / **Option 3: GitHub Release URL**

```bash
qwenpaw plugin install https://github.com/LUOSENGWA/agentteams-qwenpaw-workbench/releases/download/v0.5.0-beta.14/agentteams-qwenpaw-workbench-v0.5.0-beta.14.zip
```
