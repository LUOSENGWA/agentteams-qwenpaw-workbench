...
const DICT: Record<string, { en: string }> = {
  ...
  "Goal 令牌预算须为正整数": { en: "Goal token budget must be a positive integer" },
  "Mission 最大迭代须为 1..100 的整数": { en: "Mission max iterations must be an integer in 1..100" },
  "Mission 每故事重试须为 0..10 的整数": { en: "Mission retries per story must be an integer in 0..10" },
  ...
  "memory_manager_backend——基本 tab 可编辑（L2 白名单键）。": { en: "memory_manager_backend — editable in the Basic tab (L2 whitelisted key)." },
