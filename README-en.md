...
**Version**: 0.5.0-beta.13.17 ｜ **Author**: LUOSENGWA
...
2. Click **Install** and select the ZIP file (`agentteams-qwenpaw-workbench-v0.5.0-beta.13.17.zip`, available in [Releases](https://github.com/LUOSENGWA/agentteams-qwenpaw-workbench/releases))
...
qwenpaw plugin install /path/to/agentteams-qwenpaw-workbench-v0.5.0-beta.13.17.zip

# install from a URL (ZIP supported)
qwenpaw plugin install https://example.com/agentteams-qwenpaw-workbench-v0.5.0-beta.13.17.zip

# force reinstall (in-place upgrade)
qwenpaw plugin install /path/to/agentteams-qwenpaw-workbench-v0.5.0-beta.13.17.zip --force
```

**Option 3: GitHub Release URL**

```bash
qwenpaw plugin install https://github.com/LUOSENGWA/agentteams-qwenpaw-workbench/releases/download/v0.5.0-beta.13.17/agentteams-qwenpaw-workbench-v0.5.0-beta.13.17.zip
```
